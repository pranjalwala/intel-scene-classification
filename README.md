...
│   ├── data\_loader.py           # Dataset ingestion, augmentation, tf.data pipeline
...
│   └── download\_data.py         # Automated Kaggle dataset download helper
...
\- \*\*Self-supervised pretraining\*\*: Investigating SimCLR or BYOL on the unlabeled `seg\_pred` split as a contrastive pretraining stage.
...
This project is licensed under the MIT License. See \[LICENSE](LICENSE) for details.v
